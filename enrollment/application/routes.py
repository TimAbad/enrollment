...
@app.route("/user")
def user():
    #User(user_id=1, first_name="Tim", last_name="Abad", email="timabad@aim.com", password="1234").save()
    #User(user_id=2, first_name="Mary", last_name="Jane", email="mary.jane@aim.com", password="12345678").save()
